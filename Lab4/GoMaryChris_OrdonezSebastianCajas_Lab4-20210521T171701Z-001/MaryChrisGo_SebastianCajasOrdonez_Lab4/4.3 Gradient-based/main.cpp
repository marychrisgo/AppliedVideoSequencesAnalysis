...
int main(int argc, char ** argv)
{
	...
	//std::string dataset_path = "/home/avsa/Downloads/AVSA_lab4_datasets/datasets/";		//dataset location.
	//std::string output_path = "/home/avsa/Downloads/output/";							//location to save output videos
	...
	std::string output_path = "/home/sebasmos/Documentos/AVSA - applied video sequences Analysis/MaryChrisGo_SebastianCajasOrdonez_Lab4/";							//location to save output videos

	// Dataset paths
	std::string sequences[] = {"ball2"};										//test data
	...
	for (int s=0; s<NumSeq; s++ )
	{
		...
		GradientTracker Object = GradientTracker(list_bbox_gt[0],stride,bins,candidates);
		Rect estimated;
